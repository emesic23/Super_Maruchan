#ifndef __OLD_WRAPPER_H__
#define __OLD_WRAPPER_H__
 ...
 */
void old_init(vector_t min, vector_t max);
 ...
 */
void old_draw_polygon(list_t *points, rgb_color_t color);
 ...
 * This internally calls old_clear(), old_draw_polygon(), and old_show(),
 * so those functions should not be called directly.
 *
 * @param scene the scene to draw
 */
void old_render_scene(scene_t *scene);
 ...
 */
void old_on_key(key_handler_t handler);
